...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
                 ...
                 dtype=np.float32, normalization=None):
        """
    ...
    def loss(self, X, y=None):
        ...
        daff_2, grads["W3"], grads["b3"] = affine_backward(dout, aff_cache_2)
        daff_1, grads["W2"], grads["b2"] = affine_relu_backward(daff_2, aff_cache_1)
        dconv, grads["W1"], grads["b1"] = conv_relu_pool_backward(daff_1, conv_cache)
